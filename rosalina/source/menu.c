...
{
    if(R_FAILED(runOnAllCores(mapRosalinaKernelExtension, menuThreadStack, ((THREAD_STACK_SIZE / 3) + 7) & 7, 0))) svcBreak(USERBREAK_PANIC);
    svc_7b((void*)0x40000000); // install exception handlers -- works
